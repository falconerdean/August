...
const faqs = {
  ...
  'Common Questions': [
    ...
    },
    {
      ...
      answer: 'Vincent Bruno is a licensed professional counselor and certified natural medicine practitioner with specialized training in trauma treatment, sex therapy, and evidence-based therapeutic approaches. [Insert specific credentials, license numbers, and educational background].'
    }
  ],
  ...
  'Sex Therapy': [
    {
      question: 'What issues can sex therapy help with?',
      answer: 'Sex therapy can address a wide range of concerns including sexual dysfunction (desire, arousal, orgasm, or pain disorders), intimacy issues, desire discrepancies between partners, sex after trauma, communication about sex, body image concerns, gender and sexuality exploration, and the impact of health conditions on sexual functioning.'
    },
    {
      question: 'Do I need to come with my partner?',
      answer: 'No, sex therapy can be beneficial for both individuals and couples. While some issues may be best addressed with both partners present, many people attend sex therapy individually to work on personal concerns related to sexuality and intimacy.'
    },
    {
      question: 'What happens during a sex therapy session?',
      answer: 'Sex therapy is talk therapy—there is no physical contact or observation of sexual activity. Sessions involve discussing your concerns, learning about sexual health and function, exploring psychological factors affecting sexuality, and developing strategies to address specific challenges.'
    },
    {
      question: 'I feel embarrassed talking about sexual issues. Is that normal?',
      answer: 'Absolutely. Many people feel uncomfortable discussing sexual concerns, even with healthcare providers. Our therapists are trained to create a non-judgmental, supportive environment where you can discuss sensitive topics at your own pace. Most clients find that their initial discomfort diminishes significantly after the first few sessions.'
    },
    {
      question: 'How long does sex therapy typically take?',
      answer: 'The duration varies depending on the specific concerns, their complexity, and your goals. Some issues may show improvement after 6-8 sessions, while more complex situations might benefit from longer-term therapy. We\'ll discuss expectations about treatment length during your initial consultation.'
    },
    {
      question: 'What is your approach to sex therapy?',
      answer: 'Our approach combines evidence-based therapeutic techniques with education about sexual health and function. We draw from various therapeutic modalities including cognitive-behavioral therapy, mindfulness, and systemic approaches to address both psychological and relational aspects of sexual concerns. All treatment is tailored to your specific needs and cultural background.'
    }
  ],
  'Individual Therapy': [
    {
