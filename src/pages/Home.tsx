            ...
            <div className="grid md:grid-cols-3 gap-8">
              {features.slice(0, 3).map((feature, index) => (
                <div key={index} className="group flex flex-col rounded-2xl bg-white shadow-lg hover:shadow-xl transition-all duration-300">
                  <div className="p-6 min-h-[80px] flex items-center justify-center">
                    <h3 className="text-2xl font-semibold text-[rgb(var(--color-midnight-green))] text-center">{feature.title}</h3>
                  </div>
          ...
          <ScrollReveal>
            <div className="bg-teal-700/90 rounded-2xl p-8 backdrop-blur-sm overflow-hidden">
              <div className="grid md:grid-cols-2 gap-12 items-start mb-8">
                ...
                <div className="bg-teal-800/50 rounded-xl p-6 mb-8">
                ...
                <blockquote className="text-xl leading-relaxed text-white mb-4 italic">
